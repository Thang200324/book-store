    ...
    <div class="row">
        ...
        <div class="card card-primary">
          ...
          <form action="<?= BASE_URL_ADMIN . '?act=sua-san-pham' ?>" method="POST" enctype="multipart/form-data">
            <div class="card-body">
              ...
              <div class="form-group">
                <label for="gia_khuyen_mai">Gia khuyen mai san pham</label>
      ...
      <div class="col-md-4">
        ...
        <div class="card card-info">
          <div class="card-header">
            <h3 class="card-title">Abum Anh</h3>
...
<script>
  ...
  function addfaqs() {
    ...
    html += '<td><img src="https:img.lovepik.com/free-png/20210924/lovepik-cartoon-minimalist-reading-textbook-book-element-png-image_401359105_wh1200.png" style="width:50px; height:50px;" alt=""></td>';
