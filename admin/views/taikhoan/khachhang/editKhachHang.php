                ...
                <div class="col-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Sua tai thong tin tai khoan khach hang : <?= $khachHang['ho_ten']?></h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        ...
                        <input type="hidden" name="khach_hang_id" value="<?= $khachHang['id']?>" >
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="so_dien_thoai" value="<?= $khachHang['so_dien_thoai']?>" placeholder="Nhap so_dien_thoai">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" name="ngay_sinh" value="<?= $khachHang['ngay_sinh']?>" placeholder="Nhap ngay_sinh">
                                ...
                                <div class="form-group">
                                    <label>Dia chi</label>
                                    <input type="text" class="form-control" name="dia_chi" value="<?= $khachHang['dia_chi']?>" placeholder="Nhap dia_chi">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="trang_thai" id="inputStatus" class="form-control custom-select">
                                        <option <?= $khachHang['trang_thai'] == 1 ? 'selected' : '' ?> value="1">Hoat dong</option>
                                        <option <?= $khachHang['trang_thai'] !== 1 ? 'selected' : '' ?> value="2">Ngung hoat dong</option>
                                    </select>
                                </div>
