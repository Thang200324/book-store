                            ...
                            <div class="wrap-slick3 flex-sb flex-w">
                                ...
                                <div class="slick3 gallery-lb">
                                    <div class="item-slick3"
                                        data-thumb="{{ $shopdetail->image ? '' . Storage::url($shopdetail->image) : '' }}">
                                        <div class="wrap-pic-w pos-relative">
                                            <img src="{{ $shopdetail->image ? '' . Storage::url($shopdetail->image) : '' }}"
                                                alt="IMG-PRODUCT">

                                            <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04"
                                                href="{{ $shopdetail->image ? '' . Storage::url($shopdetail->image) : '' }}">
                                    ...
                                    <div class="item-slick3" data-thumb="{{ asset('template/images/test4.jpg') }}">
                                        <div class="wrap-pic-w pos-relative">
                                            ...
                                            <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04"
                                                href="{{ asset('template/images/test1.jpg') }}">
                                                <i class="fa fa-expand"></i>
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item-slick3" data-thumb="{{ asset('template/images/test5.jpg') }}">
                                        <div class="wrap-pic-w pos-relative">
                                            ...
                                            <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04"
                                                href="{{ asset('template/images/test2.jpg') }}">
                                                <i class="fa fa-expand"></i>
                                            </a>
                                        </div>
                                    </div>
                        ...
                        <div class="p-r-50 p-t-5 p-lr-0-lg">
                            ...
                            <div class="p-t-33">
                                ...
                                <div class="flex-w flex-r-m p-b-10">
                                    ...
                                    <div class="size-204 flex-w flex-m respon6-next" style="margin-top: 40px";>
                                        ...
                                        <button
                                            class="flex-center-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04 js-addcart-detail" style="margin-left: -10px;">
                                            Thêm vào giỏ hàng
                                        </button>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-10 col-md-8 col-lg-6 m-lr-auto">
                                    <div class="p-b-30 m-lr-15-sm">
                                            ...
                                            @if (optional($feedbackItem->users)->image)
                                                <div class="flex-w flex-t p-b-68">
                                                    <div class="wrap-pic-s size-109 bor0 of-hidden m-r-18 m-t-6">
                                                        <img src="{{ Storage::url(optional($feedbackItem->users)->image) }}"
                                                            alt="AVATAR">
                                                    </div>
                                                    <div class="size-207">
                                                        <div class="flex-w flex-sb-m p-b-17">
                                                            <span
                                                                class="mtext-107 cl2 p-r-20">{{ optional($feedbackItem->users)->name }}</span>
                                                        </div>
                                        ...
                                        <form class="w-full" method="post" action="{{ route('feedback.store') }}"
                                            enctype="multipart/form-data">
                                            @csrf
                                            <div class="row p-b-25">
                                                <div class="col-12 p-b-5">
                                                    <input type="hidden" value="{{ $shopdetail->id }}"
                                                        name="product_id">
                                                    <input class="size-110 bor8 stext-102 cl2 p-lr-20 p-tb-10"
                                                        id="review" name="content"></input>
                                                </div>
