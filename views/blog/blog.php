			...
			<div class="row">
				<div class="col-md-8 col-lg-9 p-b-80">
					<div class="p-r-45 p-r-0-lg">
						<!-- item blog -->
						<div class="p-b-63">
							<a href="<?=BASE_URL . '?act=blog-detail'?>" class="hov-img0 how-pos5-parent">
							...
							<div class="p-t-32">
								<h4 class="p-b-15">
									<a href="<?=BASE_URL . '?act=blog-detail'?>" class="ltext-108 cl2 hov-cl1 trans-04">
								...
								<div class="flex-w flex-sb-m p-t-18">
									...
									<a href="<?=BASE_URL . '?act=blog-detail'?>" class="stext-101 cl2 hov-cl1 trans-04 m-tb-10">
										Continue Reading
